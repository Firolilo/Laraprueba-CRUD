    ...
    <div class="row" id="summary-cards">
        <div class="col-md-3">
            <div class="small-box bg-danger">
                <div class="inner">
                    <h3 id="temp-max">{{ number_format(max($datosGraficas['temperatura']), 1) }}°C</h3>
        ...
        <div class="col-md-3">
            <div class="small-box bg-info">
                <div class="inner">
                    <h3 id="humidity-max">{{ number_format(max($datosGraficas['humedad']), 0) }}%</h3>
                    <p>Humedad Máxima</p>
                </div>
        ...
        <div class="col-md-3">
            <div class="small-box bg-primary">
                <div class="inner">
                    <h3 id="precip-total">{{ number_format(array_sum($datosGraficas['precipitacion']), 1) }} mm</h3>
        ...
        <div class="col-md-3">
            <div class="small-box bg-success">
                <div class="inner">
                    <h3 id="wind-max">{{ number_format(max($datosGraficas['viento']), 1) }} km/h</h3>
                    <p>Viento Máximo</p>
                </div>
