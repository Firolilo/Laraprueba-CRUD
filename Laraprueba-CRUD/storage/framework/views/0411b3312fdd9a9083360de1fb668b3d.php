<?php $__env->startSection('subtitle', 'Administradores'); ?>
<?php $__env->startSection('content_header_title', 'Gestión de Administradores'); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Administradores','theme' => 'warning','icon' => 'fas fa-user-shield'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                     <?php $__env->slot('toolsSlot', null, []); ?> 
                        <a href="<?php echo e(route('administradores.create')); ?>" class="btn btn-success btn-sm">
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $administradores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $administrador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e(++$i); ?></td>
                                        <td><?php echo e($administrador->user->name); ?></td>
                                        <td><?php echo e($administrador->user->email); ?></td>
                                        <td><?php echo e($administrador->departamento); ?></td>
                                        <td><?php echo e($administrador->nivel_acceso); ?></td>
                                        <td>
                                            <?php if($administrador->activo): ?>
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="<?php echo e(route('administradores.show', $administrador->id)); ?>" class="btn btn-info btn-sm" title="Ver">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('administradores.edit', $administrador->id)); ?>" class="btn btn-warning btn-sm" title="Editar">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('administradores.destroy', $administrador->id)); ?>" method="POST" style="display: inline;" 
                    ...
                    <div class="mt-3">
                        <?php echo $administradores->withQueryString()->links(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\OneDrive\Desktop\Proyectos\SIPII Laravel\Laraprueba-CRUD\Laraprueba-CRUD\resources\views/administrador/index.blade.php ENDPATH**/ ?>