...
<?php $__env->startSection('content_header_title', 'Panel Principal'); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Mapa de Monitoreo','theme' => 'light','icon' => 'fas fa-map-marked-alt'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
        ...
        <div class="col-lg-4">
            <?php if (isset($component)) { $__componentOriginale2b5538aaf81eaeffb0a99a88907fd7b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale2b5538aaf81eaeffb0a99a88907fd7b = $attributes; } ?>
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Áreas de Biomasa ('.e($biomasasCount).')','theme' => 'success','icon' => 'fas fa-leaf'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('adminlte-card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
                ...
                <div class="mb-3">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownFiltros" style="padding: 10px;">
                            ...
                            ?>
                            <?php $__currentLoopData = $tiposBiomasa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input filtro-biomasa" 
                                           id="filtro-<?php echo e($tipo->id); ?>" 
                                           value="<?php echo e($tipo->id); ?>" 
                                           data-tipo="<?php echo e($tipo->tipo_biomasa); ?>"
                                           checked>
                                    <label class="custom-control-label" for="filtro-<?php echo e($tipo->id); ?>">
                                        <i class="fas fa-circle" style="color: <?php echo e($tipo->color); ?>; font-size: 10px;"></i>
            ...
            <div class="card">
                <div class="card-body weather-card">
                    ...
                    <div class="value" id="temperature">
                        <?php if(isset($weather['data']['current_weather']['temperature'])): ?>
                            <?php echo e($weather['data']['current_weather']['temperature']); ?>°C
                        <?php else: ?>
                            --°C
                        <?php endif; ?>
                    </div>
            ...
            <div class="card">
                <div class="card-body weather-card">
                    ...
                    <div class="value" id="humidity">
                        <?php if(isset($weather['data']['hourly']['relative_humidity_2m'][0])): ?>
                            <?php echo e($weather['data']['hourly']['relative_humidity_2m'][0]); ?>%
                        <?php else: ?>
                            --%
                        <?php endif; ?>
                    </div>
            ...
            <div class="card">
                <div class="card-body weather-card">
                    ...
                    <div class="value" id="precipitation">
                        <?php if(isset($weather['data']['hourly']['precipitation'][0])): ?>
                            <?php echo e($weather['data']['hourly']['precipitation'][0]); ?> mm
                        <?php else: ?>
                            0 mm
                        <?php endif; ?>
                    </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body weather-card">
                    ...
                    <div class="value text-danger"><?php echo e($firesCount); ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body weather-card">
                    ...
                    <div class="value text-success"><?php echo e($biomasasCount); ?></div>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\OneDrive\Desktop\Proyectos\SIPII Laravel\Laraprueba-CRUD\Laraprueba-CRUD\resources\views/dashboard.blade.php ENDPATH**/ ?>