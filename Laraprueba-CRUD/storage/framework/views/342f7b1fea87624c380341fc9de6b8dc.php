<?php $__env->startSection('subtitle', 'Focos de Incendio'); ?>
<?php $__env->startSection('content_header_title', 'Gestión de Focos de Incendio'); ?>
...
<?php $component = JeroenNoten\LaravelAdminLte\View\Components\Widget\Card::resolve(['title' => 'Focos de Incendio','theme' => 'danger','icon' => 'fas fa-fire'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                     <?php $__env->slot('toolsSlot', null, []); ?> 
                        ...
                        <a href="<?php echo e(route('focos-incendios.create')); ?>" class="btn btn-success btn-sm">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $focosIncendios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $focosIncendio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e(++$i); ?></td>
                                        <td><?php echo e(optional($focosIncendio->fecha)->format('d/m/Y H:i')); ?></td>
                                        <td><?php echo e($focosIncendio->ubicacion); ?></td>
                                        <td>
                                            <?php if($focosIncendio->coordenadas): ?>
                                        ...
                                        <td>
                                            <span class="badge badge-<?php echo e($focosIncendio->intensidad > 7 ? 'danger' : ($focosIncendio->intensidad > 4 ? 'warning' : 'info')); ?>">
                                                <?php echo e($focosIncendio->intensidad); ?>

                                            </span>
                                        </td>
                                        <td>
                                            <div class="btn-group btn-group-sm" role="group">
                                                <a href="<?php echo e(route('focos-incendios.show', $focosIncendio->id)); ?>" class="btn btn-info btn-sm" title="Ver">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="<?php echo e(route('focos-incendios.edit', $focosIncendio->id)); ?>" class="btn btn-warning btn-sm" title="Editar">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="<?php echo e(route('focos-incendios.destroy', $focosIncendio->id)); ?>" method="POST" style="display: inline;" 
                    ...
                    <div class="mt-3 d-flex justify-content-center">
                        <?php echo $focosIncendios->withQueryString()->links('vendor.pagination.no-prev-next'); ?>
...
async function saveFires() {
    ...
    try {
        ...
        const response = await fetch('<?php echo e(route('focos-incendios.import-firms')); ?>', {
            method: 'POST',
            headers: {
...
async function loadFirmsData() {
    ...
    try {
        ...
        const saveResponse = await fetch('<?php echo e(route('focos-incendios.import-firms')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\lenovo\OneDrive\Desktop\Proyectos\SIPII Laravel\Laraprueba-CRUD\Laraprueba-CRUD\resources\views/focos-incendio/index.blade.php ENDPATH**/ ?>